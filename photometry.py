...
def do_photometry(data, apers, wcs, obstime=False, flux=False, zero_point_flux=1):
    ...
    # needed to change name, because of ambiguities due to the same name for different variables
    flux_sum = phot_table['aperture_sum_0'] - bkg_sum
...
#     m = [0, 1, 19, 14, 11]
#     defot_mags = [defot_table['col8'] - defot_table['col9'], defot_table['col8']
#                   - defot_table['col10'],
#                   defot_table['col8'] -
#                   defot_table['col11'], defot_table['col8'] -
#                   defot_table['col12'],
